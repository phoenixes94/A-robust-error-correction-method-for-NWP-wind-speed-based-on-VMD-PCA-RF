...
# plt.savefig("/ws_correct_ML/vmd_pca/corr.png")
...
file = open(r'/ws_correct_ML/vmd_pca/mlp_parameter_win.txt', mode='w')
...
data_train=pd.read_csv('/ws_correct_ML/vmd_pca/mlp训练ALL.csv') 
data_valid=pd.read_csv('/ws_correct_ML/vmd_pca/mlp验证ALL.csv')
...
ds_DS.to_csv('/ws_correct_ML/vmd_pca/testandmlp.csv')
ds_DS=pd.read_csv('/ws_correct_ML/vmd_pca/testandmlp.csv')
...
plotreg(Ytrain, Ytrain_predict,valid, valid_predict,ds_test0,ds_DS0,ds_test1,ds_DS1,label='VMD-PCA-MLP',dir_save="/ws_correct_ML/vmd_pca/MLPplotreg.png")
