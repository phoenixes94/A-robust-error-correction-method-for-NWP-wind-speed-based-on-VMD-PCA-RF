...
plt.savefig('/ws_correct_ML/vmd_pca/plot_dbn.png', bbox_inches="tight", dpi=300)
...
data_train=pd.read_csv('/ws_correct_ML/vmd_pca/dbn训练ALL.csv') 
data_valid=pd.read_csv('/ws_correct_ML/vmd_pca/dbn验证ALL.csv')
...
ds_DS.to_csv('/ws_correct_ML/vmd_pca/testanddbn.csv')
ds_DS=pd.read_csv('/ws_correct_ML/vmd_pca/testanddbn.csv')
...
plotreg(Ytrain, Ytrain_predict,valid, valid_predict,ds_test0,ds_DS0,ds_test1,ds_DS1,label='VMD-PCA-DBN',dir_save='/ws_correct_ML/vmd_pca/dbnplotreg.png')
